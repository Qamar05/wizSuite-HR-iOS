...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 0:
            // Attendance
            self.showViewController(viewController: UINavigationController.self, storyboardId: "AttendanceNavID")
        case 1:
            // MY Profile
            self.showViewController(viewController:UINavigationController.self, storyboardId: "ProfileNavID")
        case 2:
            // Birthday
            self.showViewController(viewController: UINavigationController.self, storyboardId: "BirthdayNavID")
        case 3:
            // Change Password
            self.showViewController(viewController:  UINavigationController.self, storyboardId: "ChangePwNavID")
        case 4:
            //Contact Us
            self.showViewController(viewController:  UINavigationController.self, storyboardId: "ContactUsNavID")
        case 5:
            // Settings
            self.showViewController(viewController: UINavigationController.self, storyboardId: "TermsNavID")
            //Support
        case 6:
    ...
    func showLogout(){
        ...
        alert.addAction(UIAlertAction(title: "OK", style: .destructive, handler: { (action: UIAlertAction!) in
            ...
            DispatchQueue.main.async {
                ...
                UserDefaults.standard.removeObject(forKey: "LEAVEAPPLYDATE")
                UserDefaults.standard.removeObject(forKey: "TOTAL_WORKING_HOURS")
                UserDefaults.standard.removeObject(forKey: "WEEK_WORKING_HOURS")
                UserDefaults.standard.removeObject(forKey: "MONTH_WORKING_HOURS")
...
extension UIViewController {
    ...
    func revealViewController() -> MainViewController? {
        ...
        if viewController is MainViewController {
            return viewController?.parent as? MainViewController
        }
        return nil
    }
